    ...
    >
      ...
      >
        ...
        <button
          ...
          className="text-[10px] font-semibold tracking-widest uppercase px-3 py-1.5 rounded-full transition-colors disabled:opacity-40 cursor-pointer bg-accent text-primary border border-primary/20"
        >
          Max
        </button>
      </div>
